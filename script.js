...
function getLocalizedUrl(language) {
  ...
  if (pageName === "producto-copiloto-pyme.html") {
    if (language === "en") {
      return new URL("/en/products/copilotopyme/", window.location.origin).toString();
    }
    if (language === "es") {
...
const seoMetadataOverrides = {
  ...
  zh: {
    ...
    "producto-tecnotitan-engine.html": [
      "Tecnotitan Engine | 游戏与仿真原型开发",
      "用于快速构建游戏、仿真、培训和互动产品的可复用引擎与工具包。"
    ],
    "producto-academia-tecnotitan.html": [
      "Academia Tecnotitan | 应用技术学习平台",
      "面向人工智能、软件、电子游戏、机器人技术和数字化转型的学习平台。"
    ],
    "producto-call-center-ai.html": [
      "Call Center AI Tecnotitan | 面向客服与销售的 AI 智能体",
      "用于客户服务、销售、客户跟进和联络中心自动化的对话式 AI 智能体。"
    ]
  },
  ja: {
    "index.html": [
    ...
    "producto-tecnotitan-engine.html": [
      "Tecnotitan Engine | ゲーム・シミュレーションのプロトタイピング",
      "ゲーム、シミュレーション、研修、インタラクティブ製品を迅速に試作するための再利用可能なエンジンとツールキット。"
    ],
    "producto-academia-tecnotitan.html": [
      "Academia Tecnotitan | 応用テクノロジー学習",
      "AI、ソフトウェア、ゲーム、ロボティクス、テクノロジー変革を学ぶための実践型プラットフォーム。"
    ],
    "producto-call-center-ai.html": [
      "Call Center AI Tecnotitan | サポート・営業向けAIエージェント",
      "カスタマーサポート、営業、フォローアップ、コンタクトセンター自動化のための会話型AIエージェント。"
    ]
  },
  ko: {
    "index.html": [
    ...
    "producto-tecnotitan-engine.html": [
      "Tecnotitan Engine | 게임 및 시뮬레이션 프로토타이핑",
      "게임, 시뮬레이션, 교육 및 인터랙티브 제품을 빠르게 구현하는 재사용 가능한 엔진과 툴킷입니다."
    ],
    "producto-academia-tecnotitan.html": [
      "Academia Tecnotitan | 응용 기술 학습 플랫폼",
      "인공지능, 소프트웨어, 비디오 게임, 로보틱스 및 기술 혁신을 위한 실무형 학습 플랫폼입니다."
    ],
    "producto-call-center-ai.html": [
      "Call Center AI Tecnotitan | 고객 지원 및 영업 AI 에이전트",
      "고객 지원, 영업, 후속 관리 및 컨택센터 자동화를 위한 대화형 AI 에이전트입니다."
    ]
  }
};
