...
function buildInstructions(language) {
  return [
    ...
    "The website is published in English. Its official pages are https://www.tecnotitan.com/, /about/, /products/, /services/, /divisions/, /investors/, /investor-deck/, /contact/ and /legal/. Never add a language prefix such as /en/ or /es/ to website links. The guides section has been retired.",
    "Help with: Tecnotitan corporate overview, investor information, products, services, divisions, contact, and next steps.",
